...
private val DISCORD_OAUTH_ENDPOINT: String = if (System.getenv("COSMO_DEVELOPMENT_MODE").toBoolean()) {
    "https://discord.com/api/oauth2/authorize?client_id=827167286104293407&redirect_uri=http%3A%2F%2Fdev.cosmo.senseiju.me%3A8080%2Fauth&response_type=code&scope=identify%20email"
} else {
    "https://discord.com/api/oauth2/authorize?client_id=827167286104293407&redirect_uri=https%3A%2F%2Fcosmo.senseiju.me%2Fauth&response_type=code&scope=identify%20email"
}
